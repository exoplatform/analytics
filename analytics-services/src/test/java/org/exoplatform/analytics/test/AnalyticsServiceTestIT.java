...
public class AnalyticsServiceTestIT extends BaseAnalyticsTest {
  ...
  public void testGetAnalyticsChartByUserTimeZone() {
    ...
    assertTrue("First date must correspond to 2020-02-28. System TimeZone = " + ZoneId.systemDefault().getId()
        + ", chosen timeZone = " + timeZone.getId() + " .found date = "
        + chartAggregationResult.getLabel(),
               chartAggregationResult.getLabel().contains("28"));
    ...
    assertNotNull("Unexpected injected labels (X axis) data size", chartAggregationResult.getValue());
    assertTrue("Second date must correspond to 2020-02-29. System TimeZone = " + ZoneId.systemDefault().getId()
        + ", chosen timeZone = " + timeZone.getId() + " .found date = "
        + chartAggregationResult.getLabel(),
               chartAggregationResult.getLabel().contains("29"));
